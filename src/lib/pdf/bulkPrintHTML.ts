...
import { SKU_COLOR_CODES as SHARED_SKU_COLOR_CODES } from '@/lib/fba/skuColorCodes'
...
// SKU_COLOR_CODES moved to the SHARED module (2026-07-09) — one map for packing slips AND the
// listing-optimizer color decoder. Extracted verbatim (verified byte-identical across all 3 copies).
// eslint-disable-next-line @typescript-eslint/no-unused-vars
const SKU_COLOR_CODES = SHARED_SKU_COLOR_CODES
